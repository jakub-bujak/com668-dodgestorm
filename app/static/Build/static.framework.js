...
var ASM_CONSTS = {
  4556708: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4556763: ($0) => { performance.now = function() { return $0; }; },  
 4556811: ($0) => { performance.now = function() { return $0; }; },  
 4556859: () => { performance.now = Module['emscripten_get_now_backup']; }
};
