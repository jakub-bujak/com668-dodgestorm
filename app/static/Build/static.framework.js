...
var ASM_CONSTS = {
  4557060: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4557115: ($0) => { performance.now = function() { return $0; }; },  
 4557163: ($0) => { performance.now = function() { return $0; }; },  
 4557211: () => { performance.now = Module['emscripten_get_now_backup']; }
};
