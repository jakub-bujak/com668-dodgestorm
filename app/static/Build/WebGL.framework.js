...
var ASM_CONSTS = {
  4556804: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4556859: ($0) => { performance.now = function() { return $0; }; },  
 4556907: ($0) => { performance.now = function() { return $0; }; },  
 4556955: () => { performance.now = Module['emscripten_get_now_backup']; }
};
